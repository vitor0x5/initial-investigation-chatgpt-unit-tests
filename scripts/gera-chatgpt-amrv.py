...
if len(sys.argv) < 1:
    print("error: gera-chatgpt-amrv.py")
    print("Example: gera-chatgpt-amrv.py")
    sys.exit(1)
...
for x in dados: 
    ...
    for i in range(6,10):#range(12, 33):
