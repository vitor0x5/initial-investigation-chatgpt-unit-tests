...
public class GrafoTest4{
  ...
  public void testProxAdj() throws Exception {
    ...
    assertEquals(10, grafo.proxAdj(0).peso());
  }
  ...
  public void testRetiraAresta() throws Exception {
    ...
    assertNull(grafo.retiraAresta(0, 1));
    assertEquals(20, grafo.retiraAresta(0, 2).peso());
  }
  ...
  public void testListaInserePrimeiro() throws Exception {
    Lista lista = new Lista();
    lista.inserePrimeiro("item1");
    lista.inserePrimeiro("item2");
    assertNotNull(lista.pesquisa("item2"));
    assertNotNull(lista.pesquisa("item1"));
  }
  ...
  public void testListaProximo() throws Exception {
    ...
    lista.insere("item1");
    lista.insere("item2");
    assertEquals("item1", lista.proximo());
