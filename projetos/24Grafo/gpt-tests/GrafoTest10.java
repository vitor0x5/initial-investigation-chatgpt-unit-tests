...
public class GrafoTest10{
    ...
    public void testGrafoTransposto() throws Exception {
        ...
        assertEquals(3, grafoT.peso(1, 0));
        assertTrue(grafoT.existeAresta(2, 0));
        assertEquals(5, grafoT.peso(2, 0));
        assertTrue(grafoT.existeAresta(1, 2));
        assertEquals(6, grafoT.peso(1, 2));
        assertTrue(grafoT.existeAresta(2, 1));
        assertEquals(8, grafoT.peso(2, 1));
