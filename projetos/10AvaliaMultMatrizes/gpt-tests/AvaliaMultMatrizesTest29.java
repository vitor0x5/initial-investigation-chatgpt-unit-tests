...
public class AvaliaMultMatrizesTest29{
    ...
    @Test(timeout=1000)
    public void testMultmatrizeWithZeroDValues() throws Exception {
        int n = 3;
        int[] d = {0, 0, 0};
        AvaliaMultMatrizes.multmatrize(n, d);
    }
    ...
    @Test(timeout=1000)
    public void testMultmatrizeWithNegativeDValues() throws Exception {
        int n = 3;
        int[] d = {-1, -2, -3};
        AvaliaMultMatrizes.multmatrize(n, d);
    }
    ...
    @Test(timeout=1000)
    public void testMultmatrizeWithPositiveDValues() throws Exception {
        int n = 3;
        int[] d = {1, 2, 3};
        AvaliaMultMatrizes.multmatrize(n, d);
    }
